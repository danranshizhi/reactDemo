...
export const Banner30DataSource = {
  ...
  textWrapper: {
    ...
    children: [
      ...
      { name: '电子邮件', className: 'banner3-button', children: '2287362952@qq.com' },
      {
        name: '年龄',
...
export const Content80DataSource = {
  ...
  titleWrapper: {
    ...
    children: [
      ...
      { name: 'title', children: '个人技能', className: 'title-h1' },
    ],
  },
  block: {
    ...
    children: [
      {
        ...
        children: {
          ...
          name: { className: 'block-name', children: '中物物联SaaS平台', href: 'https://saas.jemcocloud.com' },
          time: { className: 'block-time', children: '2018/7-至今' },
          title: { className: 'block-title', children: '该平台提供设备添加，新建场景，数据采集展示等，通过在场景中的物联网设备，可以方便管理人员了解场景的安全问题等' },
      ...
      },
      {
        ...
        children: {
          ...
          name: { className: 'block-name', children: '中物金服AEP平台', href: 'https://saas.jemcocloud.com'  },
          time: { className: 'block-time', children: '2018/6-至今' },
          title: { className: 'block-title', children: '中物金服AEP应用使能平台，提供涵盖订单-仓储-交易-物流-结算-融资的现货仓单数据管理服务，实现对大宗商品货物全生命周期管理的动产监管、动态监测；为金融机构和交易平台提供仓单动态大数据服务；为仓储物流方提供物联网+区块链监管技术支撑；为实体企业对接仓单融资服务和仓单风险管理' },
          content: { className: 'block-content', children: [
            '搭建前端基础框架，包括ui样式',
            '还原设计稿,实现各个子页面',
            '完成后台接口对接，实现数据交互',
      ...
      },
      {
        ...
        children: {
          ...
          name: { className: 'block-name', children: '中物物联官网', href: 'http://www.jemcocloud.com' },
          time: { className: 'block-time', children: '2018/4-2018/5' },
          title: { className: 'block-title', children: '该项目主要为了展示本公司的业务范围，以便于合作者，外部人员更好的了解公司的经营范围。' },
          content: { className: 'block-content', children: ['将设计稿还原为web页面，解决部分兼容性问题'] },
        },
      },
      {
        name: 'block3',
        ...
        children: {
          ...
          name: { className: 'block-name', children: '通力电梯本地大屏', href: 'https://kc3ip-bigscreen-customer-dev.mychinabluemix.net/#/login' },
          time: { className: 'block-time', children: '2017/11-2018/2' },
          title: { className: 'block-title', children: '该项目为通力电梯为客户提供的，主要是为了获取电梯的实时故障，实时状态等，从而可以了解电梯的运转情况。通过按钮切换，完成三种主题风格的切换' },
          content: { className: 'block-content', children: [
              '还原ui设计稿中三种风格的详情页面及子页面等',
              '通过发送ajax请求，调用通力api接口，发送websocket请求，获得实时数据，并进行实时数据进行绑定，电梯状态的切换等',
